...
namespace Nomis.MantleExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Mantle Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddMantleExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<MantleExplorerSettings>(configuration);
            return services
                .AddTransient<IMantleExplorerClient, MantleExplorerClient>()
                .AddTransientInfrastructureService<IMantleScoringService, MantleExplorerService>();
        }
    }
}