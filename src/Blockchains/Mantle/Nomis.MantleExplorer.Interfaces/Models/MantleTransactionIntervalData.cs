// ------------------------------------------------------------------------------------------------------
// <copyright file="MantleTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.MantleExplorer.Interfaces.Models
{
    ...
    public class MantleTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToBit();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToBit();
        ...
        public decimal AmountInSumValue => AmountInSum.ToBit();
